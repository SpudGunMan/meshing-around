...
trap_list = ("ping","ack","testing","pong","motd","help","sun","solar","hfcond","lheard","whereami","tide","moon") #A list of strings to trap and respond to
welcome_message = "MeshBot, here for you like a friend who is not. Try sending: ping @foo  or, help"
help_message = "Commands are: ping, ack, motd, sun, solar, hfcond, Lheard, whereami, tide, moon"
